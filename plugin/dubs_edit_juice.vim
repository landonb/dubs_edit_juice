...
function! s:wire_keys_select_lines_to_window_first_and_last() abort
  ...
  nnoremap <silent> <C-S-PageUp> :set selection=exclusive<CR>vH<C-G>
  inoremap <silent> <C-S-PageUp> <C-O>:set selection=exclusive<CR><C-O>vH<C-G>
  vnoremap <C-S-PageUp> H

  " Ctrl-Shift-PageDown selects from cursor to last line of window
  nnoremap <silent> <C-S-PageDown> :set selection=exclusive<CR>vL<C-G>
  inoremap <silent> <C-S-PageDown> <C-O>:set selection=exclusive<CR><C-O>vL<C-G>
